...
namespace pimoroni {
  ...
  public:
    ...
    //static const uint16_t LOW = 0x0000;
    //static const uint16_t HIGH = 0x0001;
  ...
  private:
    ...
    //--------------------------------------------------
  public:
    IOExpander(TwoWire *i2c, uint8_t address=DEFAULT_I2C_ADDRESS, uint32_t timeout = 1, bool debug = false);
